const SW_RELEASE='v364-barbell-thumbnail-fix';
const STATIC_CACHE='unvrsl-static-v364';
const CORE_ASSETS=[
  './app.js?v=316',
  ...
  './gif-source/barbell/01.txt?v=362',
  './gif-source/barbell/02.txt?v=362',
  './gif-source/barbell/03.txt?v=362',
  './gif-source/barbell/04.txt?v=362',
  './gif-source/barbell/05.txt?v=362',
  './gif-source/barbell-v364/01.txt?v=364',
  './gif-source/barbell-v364/02.txt?v=364',
  './gif-source/barbell-v364/03.txt?v=364',
  './gif-source/barbell-v364/04.txt?v=364',
  './gif-source/barbell-v364/05.txt?v=364',
  './gif-source/barbell-v364/06.txt?v=364',
  './gif-source/smith/01.txt?v=362',
  './gif-source/smith/02.txt?v=362',
  './gif-source/smith/03.txt?v=362',
  './gif-source/smith/04.txt?v=362',
  './gif-source/smith/05.txt?v=362',
  './local-media-fix-v357.js?v=357',
  './hip-thrust-detail-fix-v358.js?v=362',
  './barbell-media-fix-v364.js?v=364',
