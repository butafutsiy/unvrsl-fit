const SW_RELEASE='v359-hip-gif-rebuild';
const STATIC_CACHE='unvrsl-static-v359';
const CORE_ASSETS=[
  './app.js?v=316',
  ...
  './assets/hip-thrust-machine.gif?v=359',
  './assets/hip-thrust-smith.gif?v=359',
  './assets/hip-thrust-barbell.gif?v=359',
