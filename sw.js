const SW_RELEASE='v361-pwa-recovery';
const STATIC_CACHE='unvrsl-static-v361';
const CORE_ASSETS=[
  './app.js?v=316',
  ...
  './assets/hip-thrust-machine.gif?v=361',
  './assets/hip-thrust-smith.gif?v=361',
  './assets/hip-thrust-barbell.gif?v=361',
  './local-media-fix-v357.js?v=357',
  './hip-thrust-detail-fix-v358.js?v=361',
