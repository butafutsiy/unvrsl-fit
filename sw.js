const SW_RELEASE='v358-hip-thrust-playback';
const STATIC_CACHE='unvrsl-static-v358';
const CORE_ASSETS=[
  './app.js?v=316',
  ...
  './assets/hip-thrust-machine.gif?v=358',
  './assets/hip-thrust-smith.gif?v=358',
  './assets/hip-thrust-barbell.gif?v=358',
  './local-media-fix-v357.js?v=357',
  './hip-thrust-detail-fix-v358.js?v=358',
