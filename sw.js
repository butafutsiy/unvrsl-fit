const SW_RELEASE='v360-barbell-hip-fix';
const STATIC_CACHE='unvrsl-static-v360';
const CORE_ASSETS=[
  './app.js?v=316',
  ...
  './assets/hip-thrust-machine.gif?v=360',
  './assets/hip-thrust-smith.gif?v=360',
  './assets/hip-thrust-barbell.gif?v=360',
  './local-media-fix-v357.js?v=357',
  './hip-thrust-detail-fix-v358.js?v=360',
