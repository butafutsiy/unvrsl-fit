...
(()=>{
  ...
  const R={
    ...
    5:{
      ...
      'Румынская тяга':[4,6],'Сгибание ног лёжа':[8,10],'Выпады назад':[12,16],'Зашагивания':[12,16],
    ...
    8:{
      'Присед HB#test':[1,3],'Присед HB#backoff':[5,7],'Жим ногами':[10,12],'Разгибание ног':[8,12],'Сведение ног':[8,12],'Икры':[8,12],
      'Жим лёжа#test':[1,3],'Жим лёжа#backoff':[5,7],'Жим гантелей на наклонной':[10,12],'Разводка / бабочка':[8,12],'Жим гантелей сидя':[10,12],'Махи в стороны':[8,12],'Кроссовер':[8,12],'EZ / скамья Скотта':[8,12],'Молотковые сгибания с канатом':[8,12],
      'Тяга штанги в наклоне':[3,5],'Тяга Т-грифа':[10,12],'Верхний блок':[12,15],'Нижний блок':[12,15],'Жим плеч в тренажёре':[10,12],'Задняя дельта':[8,12],'Французский жим EZ':[8,12],'Канат на трицепс':[8,12],'Гиперэкстензия с диском':[15,20],
      'Румынская тяга#test':[1,3],'Румынская тяга#backoff':[8,10],'Ягодичный мост#heavy':[3,5],'Ягодичный мост#backoff':[10,12],'Сгибание ног лёжа':[8,12],'Выпады назад':[20,24],'Зашагивания':[20,24],'Разведение ног':[8,12],
      'Подъём штанги на бицепс':[8,12],'Армейский жим#test':[1,3],'Армейский жим#backoff':[5,7],'Разгибание гантели из-за головы':[8,12],'Сгибание гантелей с супинацией':[8,12],'Канат на трицепс':[8,12],'Молотковые сгибания':[8,12],'Сгибание рук в блоке':[8,12],'Французский жим с гантелями':[8,12]
    }
  };
  ...
  const target=(week,e)=>{
    ...
    if(Number(week)===8&&b==='Румынская тяга'&&v==='test')return /2[–-]3ПМ/i.test(e.n)?[2,3]:[1,1];
