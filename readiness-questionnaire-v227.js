...
(()=>{
  ...
  style.textContent=`
    ...
    @media(max-width:520px){
      ...
      .rq227-rows{gap:10px}.rq227-row{grid-template-columns:110px minmax(0,1fr);gap:7px}.rq227-label{font-size:13.5px;letter-spacing:-.35px;white-space:nowrap}.rq227-scale{gap:5px}.rq227-score{height:41px;border-radius:13px;font-size:15px}.rq227-scale-ends{font-size:9px;margin-top:3px}
  ...
  function manualData(percent){
    ...
    return{sleep:v.sleep,energy:v.energy,stress:v.stress,soreness:v.recovery==null?null:6-v.recovery,recovery:v.recovery,stressScore:v.stress,score:r.score,percent,factor:1+percent/100,skipped:false,manual:true,autoPercent:r.percent,at:new Date().toISOString()};
  }
