...
(function(root,factory){
  ...
  function boot(W,A){
    ...
    function control(group){
      ...
      if(!active)return `<button class="mw304-control empty" type="button" onclick="machineWeightOpen304('${encodeURIComponent(group.key)}')"><span><b>Оборудование</b><small>${cardio?'Указать модель аэробайка':'Указать тренажёр или снаряд'}</small></span><i>›</i></button>`;
