...
(()=>{
 ...
 async function ensureLoadModel(){
  ...
  if(!document.querySelector('script[data-unvrsl-load-model-v292]')){const s=document.createElement('script');s.src='training-load-model.js?v=416';s.async=false;s.dataset.unvrslLoadModelV292='1';document.body.appendChild(s)}
