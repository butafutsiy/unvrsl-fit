...
test('only the canonical program flow owns creation, ranges and preparation',()=>{
  ...
  assert.ok(index.indexOf('program-model.js?v=406')<index.indexOf('coach-programs.js?v=406'));
  assert.ok(index.indexOf('training-engine.js?v=406')<index.indexOf('readiness-autoregulation.js?v=406'));
