...
test('only the canonical program flow owns creation, ranges and preparation',()=>{
  ...
  assert.ok(index.indexOf('program-model.js?v=419')<index.indexOf('coach-programs.js?v=419'));
  assert.ok(index.indexOf('training-engine.js?v=419')<index.indexOf('readiness-autoregulation.js?v=419'));
