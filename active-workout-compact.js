...
(()=>{
  ...
  s.textContent=`
    ...
    #start .exercise:not(.anton-superset):not(.anton-single){padding:13px 14px!important;margin:8px 0!important;border-radius:20px!important}
    #start .exercise:not(.anton-superset):not(.anton-single)>.row.between{gap:9px!important;align-items:flex-start!important}
    ...
    #start .exercise:not(.anton-superset):not(.anton-single) .head-actions{display:flex!important;flex-direction:column!important;gap:5px!important;flex:0 0 auto!important}
