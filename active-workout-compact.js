...
(()=>{
  ...
  s.textContent=`
    ...
    #start .workout-head>.row{display:grid!important;grid-template-columns:minmax(0,1fr) auto auto!important;gap:8px!important;align-items:start!important;min-width:0!important}
    ...
    #start .workout-head>.row>.btn,#start .workout-head>.row>button:not(.chip){flex:0 0 auto!important;min-width:70px!important;max-width:82px!important;white-space:nowrap!important;align-self:center!important;padding:10px 12px!important;overflow:hidden!important;text-overflow:clip!important}
    ...
    #start .exercise:not(.anton-superset):not(.anton-single)>.row.between{display:grid!important;grid-template-columns:minmax(0,1fr) max-content!important;grid-template-areas:'name name' 'rule rule' 'chips actions'!important;column-gap:8px!important;row-gap:4px!important;align-items:center!important;min-width:0!important}
    ...
    #start .exercise:not(.anton-superset):not(.anton-single) .chips.compact{grid-area:chips!important;display:flex!important;flex-wrap:nowrap!important;gap:5px!important;margin:2px 0 0!important;align-self:center!important;min-width:0!important;overflow:hidden!important}
    #start .exercise:not(.anton-superset):not(.anton-single) .chips.compact .chip{flex:0 1 auto!important;min-width:0!important;padding:5px 8px!important;font-size:11.5px!important;line-height:1.05!important;white-space:nowrap!important}
    #start .exercise:not(.anton-superset):not(.anton-single) .head-actions{grid-area:actions!important;display:flex!important;flex-direction:row!important;flex-wrap:nowrap!important;gap:4px!important;width:auto!important;max-width:none!important;align-items:center!important;justify-content:flex-end!important;align-self:center!important;margin-top:2px!important;white-space:nowrap!important}
    #start .exercise:not(.anton-superset):not(.anton-single) .head-actions .btn.tiny{width:34px!important;height:34px!important;min-width:34px!important;min-height:34px!important;padding:0!important;border-radius:11px!important;font-size:14px!important;display:grid!important;place-items:center!important}
    #start .exercise:not(.anton-superset):not(.anton-single) .head-actions .btn.tiny[onclick*="openAutoWarmup"]{width:auto!important;min-width:66px!important;max-width:none!important;height:34px!important;min-height:34px!important;padding:0 9px!important;font-size:10.5px!important;line-height:1!important;white-space:nowrap!important}
    #start .exercise:not(.anton-superset):not(.anton-single) .method-strip{margin:7px 0 0!important}

    /* v175: set / kg / reps / RPE / RIR / complete, always one row. */
    #start .exercise:not(.anton-superset):not(.anton-single) .sethead,
    #start .exercise:not(.anton-superset):not(.anton-single) .setrow{display:grid!important;grid-template-columns:27px minmax(48px,1fr) minmax(46px,.86fr) 54px 46px 34px!important;column-gap:5px!important;align-items:center!important;width:100%!important;min-width:0!important}
    #start .exercise:not(.anton-superset):not(.anton-single) .sethead{margin:10px 0 0!important;font-size:10px!important;line-height:1!important;text-align:center!important}
    ...
    @media(max-width:430px){
      ...
      #start .workout-head>.row>.btn,#start .workout-head>.row>button:not(.chip){min-width:64px!important;max-width:72px!important;padding:9px!important;font-size:12px!important}
      ...
      #start .exercise:not(.anton-superset):not(.anton-single) .sethead,
      #start .exercise:not(.anton-superset):not(.anton-single) .setrow{grid-template-columns:25px minmax(45px,1fr) minmax(43px,.82fr) 50px 43px 32px!important;column-gap:4px!important}
      #start .exercise:not(.anton-superset):not(.anton-single) .setrow input{min-height:37px!important;padding:6px 2px!important;font-size:13.5px!important}
    ...
    @media(max-width:365px){
      #start .exercise:not(.anton-superset):not(.anton-single)>.row.between{grid-template-columns:1fr!important;grid-template-areas:'name' 'rule' 'chips' 'actions'!important}
      ...
      #start .exercise:not(.anton-superset):not(.anton-single) .sethead,
      #start .exercise:not(.anton-superset):not(.anton-single) .setrow{grid-template-columns:23px minmax(41px,1fr) minmax(40px,.8fr) 46px 40px 30px!important;column-gap:3px!important}
      #start .exercise:not(.anton-superset):not(.anton-single) .setrow input{font-size:12.5px!important}
