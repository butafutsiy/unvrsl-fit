...
(()=>{
  ...
  window.saveProgramExercise=function(pid,wi,di,nameToken,sourceToken,bpToken,tgToken,eqToken,existingIndex){
    ...
    const obj={...(old||{}),id:old?.id||uid('pex'),exerciseId:workoutRegistry.identity(editingLoadExercise),loadType,n,sourceId:decodeURIComponent(sourceToken||'')||null,bp:decodeURIComponent(bpToken||''),tg:decodeURIComponent(tgToken||''),eq:decodeURIComponent(eqToken||''),kind,method,reps:canonicalReps,effortSourceMode:effortMode,effortType,rpe:rpeTarget,tempoMode,tempo,tempoLight:method==='UNVRSL'?tempoLight:null,restMode,rest,weightMode,parameterOverrides,innerRest:INNER_REST[method],heavyReps:method==='UNVRSL'?heavyReps:null,lightReps:method==='UNVRSL'?lightReps:null,lightWeight:method==='UNVRSL'?lightWeight:null,middleSets:method==='UNVRSL'?middleSets:null,middleReps:method==='UNVRSL'?middleReps:null,middleWeight:method==='UNVRSL'?middleWeight:null,miniSets:method==='SLDR'?sldrSets:null,repDrop:method==='SLDR'?sldrDrop:null,note,sets};
