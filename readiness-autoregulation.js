...
(()=>{
  ...
  function loadBuiltinProfile(){
    ...
    const x=document.createElement('script');x.src='builtin-cycle-load-profile.js?v=386';x.async=false;x.dataset.unvrslBuiltinLoadProfileV296='1';x.onerror=()=>console.warn('UNVRSL built-in load profile v299 failed to load');document.body.appendChild(x)
  }
  function loadSergeyProfile(){
    ...
    const x=document.createElement('script');x.src='sergey-load-profile.js?v=386';x.async=false;x.dataset.unvrslSergeyLoadProfileV297='1';x.onerror=()=>console.warn('UNVRSL Sergey load profile v301 failed to load');document.body.appendChild(x)
  }
  function loadTemplateProfile(){
    ...
    const x=document.createElement('script');x.src='template-load-profile.js?v=386';x.async=false;x.dataset.unvrslTemplateLoadProfileV302='1';x.onerror=()=>console.warn('UNVRSL template load profile v302 failed to load');document.body.appendChild(x)
  }
  function loadRecommendationCopy(){
    ...
    const x=document.createElement('script');x.src='recommendation-copy.js?v=386';x.async=false;x.dataset.unvrslRecommendationCopyV300='1';x.onerror=()=>console.warn('UNVRSL recommendation copy v300 failed to load');document.body.appendChild(x)
  }
  let attempts=0;
  function load(){
    ...
    s.src=attempts===1?'training-engine.js?v=386':`training-engine.js?v=386-${attempts}`;
  ...
  function loadQuestionnaire(){
    ...
    const q=document.createElement('script');q.src='readiness-questionnaire.js?v=386';q.async=false;q.dataset.unvrslReadinessV227='1';q.onload=()=>{if(window.__unvrslReadinessQuestionnaireV227)mark('questionnaire')};document.body.appendChild(q)
  }
  function loadExactPlanFix(){
    ...
    const f=document.createElement('script');f.src='exact-plan-fix.js?v=386';f.async=false;f.dataset.unvrslExactPlanV230='1';f.onload=()=>{if(window.__unvrslExactPlanFixV257)mark('exact')};document.body.appendChild(f)
  }
  function loadWorkoutShare(){
    ...
    const x=document.createElement('script');x.src='share-progress-template.js?v=386';x.async=false;x.dataset.unvrslShareV264='1';document.body.appendChild(x)
  }
  function loadPrescriptionBridge(){
    ...
    const x=document.createElement('script');x.src='training-prescription-bridge.js?v=386';x.async=false;x.dataset.unvrslPrescriptionBridgeV288='1';x.onerror=()=>console.warn('UNVRSL prescription bridge v288 failed to load');document.body.appendChild(x)
  }
