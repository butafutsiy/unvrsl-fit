...
(()=>{
  ...
  function load(){
    ...
    s.src=attempts===1?'training-engine.js?v=383':`training-engine.js?v=383-${attempts}`;
  ...
  function loadQuestionnaire(){
    ...
    const q=document.createElement('script');q.src='readiness-questionnaire.js?v=383';q.async=false;q.dataset.unvrslReadinessV227='1';q.onload=()=>{if(window.__unvrslReadinessQuestionnaireV227)mark('questionnaire')};document.body.appendChild(q)
  }
