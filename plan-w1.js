...
(()=>{
  if(window.__unvrslNativePreviewRangesLoaderV278)return;
  window.__unvrslNativePreviewRangesLoaderV278=true;
  const load=()=>{
    if(document.querySelector('script[data-unvrsl-native-preview-v278]'))return;
    const s=document.createElement('script');
    s.src='native-preview-ranges-v278.js?v=278';
    s.async=false;
    s.dataset.unvrslNativePreviewV278='1';
