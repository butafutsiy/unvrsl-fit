'use strict';
(()=>{
  const W=window,D=document,REV=324;
  if(W.__unvrslOfflineProgressV324)return;
  W.__unvrslOfflineProgressV324=true;W.__unvrslOfflineProgressV323=true;W.__unvrslOfflineProgressV322=true;W.__unvrslOfflineProgressV321=true;
  ...
  openDetail.__offlineProgressV324=true;openDetail.__offlineProgressV323=true;openDetail.__offlineProgressV322=true;openDetail.__offlineProgressV321=true;
  ...
  customStrength.__offlineProgressV324=true;customStrength.__offlineProgressV323=true;customStrength.__offlineProgressV322=true;customStrength.__offlineProgressV321=true;
  ...
  const style=D.createElement('style');style.id='unvrsl-offline-progress-v324-style';style.textContent=`
  ...
  function install(){
    ...
    W.offlineClientDetail=openDetail;W.offlineCustomStrengthSheet=customStrength;W.offlineEditClientSheet=editClient;
    try{offlineClientDetail=openDetail;offlineCustomStrengthSheet=customStrength;offlineEditClientSheet=editClient}catch(_){ }
  }
