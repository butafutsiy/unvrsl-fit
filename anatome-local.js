...
(()=>{
  ...
  function loadFullMuscleMap(){if(window.__unvrslMuscleMapFullV176||document.querySelector('script[data-unvrsl-muscle-map-full]'))return;const s=document.createElement('script');s.src='muscle-map-full.js?v=379';s.async=false;s.dataset.unvrslMuscleMapFull='1';document.body.appendChild(s)}
