...
(()=>{
  ...
  function loadTrainingLoadModel(){
    ...
    const s=D.createElement('script');s.src='training-load-model.js?v=387';s.async=false;s.dataset.unvrslLoadModelV292='1';s.onerror=()=>console.warn('UNVRSL load model v292 failed to load');D.body?.appendChild(s)
  }
  function loadProgramIntensity(){
    ...
    const s=D.createElement('script');s.src='program-intensity-autoweight.js?v=387';s.async=false;s.dataset.unvrslProgramIntensityV261='1';s.onerror=()=>console.warn('UNVRSL program intensity UI failed to load');D.body?.appendChild(s)
  }
  function loadTrainerClientProgramEdit(){
    ...
    const s=D.createElement('script');s.src='trainer-client-program-edit.js?v=387';s.async=false;s.dataset.unvrslTrainerClientEditV262='1';s.onerror=()=>console.warn('UNVRSL trainer client program edit v262 failed to load');D.body?.appendChild(s)
  }
  function loadProgramWeekRpeRir(){
    ...
    const s=D.createElement('script');s.src='program-week-rpe-rir.js?v=387';s.async=false;s.dataset.unvrslWeekRpeRirV263='1';s.onerror=()=>console.warn('UNVRSL week RPE RIR v263 failed to load');D.body?.appendChild(s)
  }
  function loadProgramRepRange(){
    ...
    const s=D.createElement('script');s.src='program-rep-range.js?v=387';s.async=false;s.dataset.unvrslProgramRepRangeV266='1';s.onerror=()=>console.warn('UNVRSL program rep range v266 failed to load');D.body?.appendChild(s)
  }
  function loadBuiltInPlanRepRanges(){
    ...
    const s=D.createElement('script');s.src='built-in-plan-rep-ranges.js?v=387';s.async=false;s.dataset.unvrslBuiltInRangesV267='1';s.onerror=()=>console.warn('UNVRSL built-in plan rep ranges v267 failed to load');D.body?.appendChild(s)
  }
  function loadProgramWeekRepGuidance(){
    ...
    const s=D.createElement('script');s.src='program-week-rep-guidance.js?v=387';s.async=false;s.dataset.unvrslWeekRepGuidanceV268='1';s.onerror=()=>console.warn('UNVRSL weekly rep guidance v268 failed to load');D.body?.appendChild(s)
  }
  ...
  function localCoreReady(){
    ...
    const deadline=elapsed()>=2600;
    if(!W.__unvrslCriticalModulesReadyV320&&!deadline)return false;
    if((!W.__unvrslUiStabilityV316||!W.__unvrslTrainerShellV252)&&!deadline)return false;
    if(deadline&&!W.__unvrslCriticalModulesReadyV320){
      W.__unvrslCriticalModulesBypassedV387=true;
      W.__unvrslCriticalModulesReadyV320=true
    }
    return true
  }
  function coreReady(){
  ...
  async function finalize(){
    ...
    try{
      ...
      W.__unvrslStartupComplete=true;clearTimeout(W.__unvrslBootWatchdogV387);
