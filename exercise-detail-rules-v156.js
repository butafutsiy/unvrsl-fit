...
(()=>{
  ...
  if(!document.querySelector('script[data-unvrsl-workout-recommendation-v177]')){
    const s=document.createElement('script');
    s.src='workout-recommendation-v177.js';
    s.async=false;
    s.dataset.unvrslWorkoutRecommendationV177='1';
    document.body.appendChild(s);
  }
})();
