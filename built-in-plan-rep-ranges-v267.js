...
(()=>{
  ...
  const R={
    1:{
      ...
      'Жим лёжа':[8,10],'Жим гантелей на наклонной':[10,12],'Разводка / бабочка':[12,15],'Жим гантелей сидя':[8,10],'Махи в стороны':[15,18],'Кроссовер':[12,15],'EZ / скамья Скотта':[10,12],'Молотковые сгибания с канатом':[12,15],'Отжимания с дополнительным весом':[10,15],
      'Тяга штанги в наклоне':[10,12],'Подтягивания с весом':[8,10],'Подтягивания':[8,10],'Тяга Т-грифа':[10,12],'Верхний блок':[12,15],'Нижний блок':[12,15],'Жим плеч в тренажёре':[12,15],'Задняя дельта':[15,20],'Французский жим EZ':[12,15],'Канат на трицепс':[12,15],'Гиперэкстензия с диском':[15,20],
    ...
    2:{
      ...
      'Жим лёжа':[6,8],'Жим гантелей на наклонной':[8,10],'Разводка / бабочка':[10,12],'Жим гантелей сидя':[6,8],'Махи в стороны':[12,15],'Кроссовер':[10,12],'EZ / скамья Скотта':[8,10],'Молотковые сгибания с канатом':[10,12],'Отжимания с дополнительным весом':[8,12],
      'Тяга штанги в наклоне':[8,10],'Подтягивания с весом':[6,8],'Подтягивания':[6,8],'Тяга Т-грифа':[8,10],'Верхний блок':[10,12],'Нижний блок':[10,12],'Жим плеч в тренажёре':[10,12],'Задняя дельта':[12,15],'Французский жим EZ':[10,12],'Канат на трицепс':[10,12],'Гиперэкстензия с диском':[12,15],
    ...
    3:{
      ...
      'Жим гантелей на наклонной':[6,8],'Разводка / бабочка':[10,12],'Жим гантелей сидя':[8,10],'Махи в стороны':[15,20],'EZ / скамья Скотта':[6,8],'Молотковые сгибания с канатом':[15,18],'Отжимания с дополнительным весом':[8,12],
      'Тяга штанги в наклоне':[6,8],'Тяга Т-грифа':[6,8],'Нижний блок':[8,10],'Жим плеч в тренажёре':[8,10],'Задняя дельта':[15,18],'Французский жим EZ':[8,10],'Канат на трицепс':[15,18],'Гиперэкстензия с диском':[15,20],
      'Румынская тяга':[6,8],'Выпады назад':[12,16],'Зашагивания':[16,20],'Разведение ног':[15,18],
      'Армейский жим':[5,7],'Разгибание гантели из-за головы':[8,10],'Сгибание гантелей с супинацией':[8,10],'Молотковые сгибания':[8,10],'Сгибание рук в блоке':[10,12],'Французский жим с гантелями':[8,10]
    },
    4:{
    ...
    5:{
      ...
      'Жим гантелей на наклонной':[5,7],'Разводка / бабочка':[8,10],'Жим гантелей сидя':[6,8],'Махи в стороны':[10,12],'Кроссовер':[8,10],'EZ / скамья Скотта':[6,8],'Отжимания с дополнительным весом':[6,10],
      'Тяга штанги в наклоне':[4,6],'Тяга Т-грифа':[5,7],'Нижний блок':[6,8],'Жим плеч в тренажёре':[6,8],'Задняя дельта':[10,12],'Французский жим EZ':[6,8],'Канат на трицепс':[8,10],'Гиперэкстензия с диском':[12,15],
      'Румынская тяга':[5,7],'Сгибание ног лёжа':[8,10],'Выпады назад':[16,20],'Зашагивания':[12,16],
    ...
    6:{
      ...
      'Жим лёжа':[8,10],'Жим гантелей на наклонной':[10,12],'Разводка / бабочка':[12,15],'Жим гантелей сидя':[10,12],'Махи в стороны':[15,20],'EZ / скамья Скотта':[10,12],'Молотковые сгибания с канатом':[10,12],'Отжимания с дополнительным весом':[8,12],
    ...
    7:{
      ...
      'Жим лёжа':[3,5],'Жим гантелей на наклонной':[5,7],'Разводка / бабочка':[8,10],'Жим гантелей сидя':[5,7],'Махи в стороны':[8,10],'Кроссовер':[8,10],'EZ / скамья Скотта':[5,7],'Молотковые сгибания с канатом':[8,10],'Отжимания с дополнительным весом':[5,8],
      'Тяга штанги в наклоне':[3,5],'Подтягивания с весом':[3,5],'Подтягивания':[3,5],'Тяга Т-грифа':[4,6],'Верхний блок':[8,10],'Нижний блок':[5,7],'Жим плеч в тренажёре':[5,7],'Задняя дельта':[8,10],'Французский жим EZ':[5,7],'Канат на трицепс':[6,8],'Гиперэкстензия с диском':[10,12],
    ...
    8:{
      ...
      'Тяга штанги в наклоне':[3,5],'Тяга Т-грифа':[10,12],'Верхний блок':[12,15],'Нижний блок':[15,18],'Жим плеч в тренажёре':[10,12],'Задняя дельта':[15,20],'Французский жим EZ':[10,12],'Канат на трицепс':[15,18],'Гиперэкстензия с диском':[15,20],
  ...
  function repLabel(e){
    ...
    const lo=Number(e?.rMin),hi=Number(e?.rMax);
    if(Number.isFinite(lo)&&Number.isFinite(hi)){
      if(e?.sd){const a=lo/2,b=hi/2;return `${a===b?a:`${a}–${b}`} на ногу`}
      return lo===hi?String(lo):`${lo}–${hi}`
    }
    return String(e?.r||'—')
  }
  function applyRanges(){
    let routines=[];try{routines=typeof ROUTINES!=='undefined'?ROUTINES:(W.UNVRSL_ROUTINES||[])}catch(_){routines=W.UNVRSL_ROUTINES||[]}
    routines.forEach(r=>{
      (r.e||[]).forEach(e=>{
        const t=targetFor(r.w,e);
        if(!t){
          if(Number.isFinite(Number(e.r))){e.rMin=Number(e.r);e.rMax=Number(e.r);e.targetRepMin=Number(e.r);e.targetRepMax=Number(e.r)}
          return
        }
        const [lo,hi]=t;e.rMin=lo;e.rMax=hi;e.targetRepMin=lo;e.targetRepMax=hi;e.repRangeRevision=REV;e.r=lo;
      })
    });
  ...
  function patchSession(){
    let cur=null;try{cur=typeof session==='function'?session:W.session}catch(_){cur=W.session}
    if(typeof cur!=='function'||cur.__bir267)return false;
    const wrapped=function(r){
      const s=cur.apply(this,arguments);
      (r?.e||[]).forEach((src,ei)=>{const ex=s?.ex?.[ei];if(!ex)return;(ex.set||[]).forEach(set=>{
        if(Number.isFinite(Number(src.rMin)))set.targetRepMin=Number(src.rMin);
        if(Number.isFinite(Number(src.rMax)))set.targetRepMax=Number(src.rMax)
      })});
      s.repRangeRevision=REV;return s
    };
    wrapped.__bir267=true;wrapped.__bir267Base=cur;W.session=wrapped;try{session=wrapped}catch(_){ }return true
  }
  function patchPreview(){
    let cur=null;try{cur=typeof preview==='function'?preview:W.preview}catch(_){cur=W.preview}
    if(typeof cur!=='function'||cur.__bir267)return false;
    const wrapped=function(w,c){
      let r=null;try{r=typeof rmap!=='undefined'?rmap.get(`${w}-${c}`):null}catch(_){ }
      if(!r)return cur.apply(this,arguments);
      const E=typeof esc==='function'?esc:(x=>String(x??''));
      const rp=typeof rest==='function'?rest:(()=>90);
      const rpe=(()=>{try{return typeof RPE!=='undefined'?RPE[r.w]:8}catch(_){return 8}})();
      if(typeof modal!=='function')return cur.apply(this,arguments);
      modal(`<div class="row between"><div><h2>${E(r.c)} · ${E(r.t)}</h2><div class="muted">W${r.w} · RPE ${rpe}</div></div><button class="btn tiny" onclick="closeModal()">✕</button></div>${r.e.map((e,i)=>`<div class="listline"><b>${E(e.n)}</b><div class="muted small">${e.s||1}×${repLabel(e)}${e.w?` · ${e.w} кг`:''} · отдых ${rp(r,e,i)} сек</div>${e.d?`<div class="exnote">${E(e.d)}</div>`:''}</div>`).join('')}<button class="btn primary full" onclick="begin(${r.w},'${r.c}')">Начать</button>`)
    };
