...
(()=>{
 const sources=[
  'premium-ui.js?v=385','stable-ui.js?v=385','mockup-ui.js?v=385','density-ui.js?v=385',
  'mobile-final-fix.js?v=385','home-stats.js?v=385',
  'client-nav-hotfix.js?v=385','trainer-shell.js?v=385'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=385','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=385','client-link.js','auth-password.js','checkin.js','checkin-singleton-fix.js','offline-clients.js','offline-create-measures.js','online-progress.js','client-ui-fix.js?v=385','trainer-plan-controls.js','trainer-tap-fix.js','trainer-direct-ui.js'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=385','female-program-templates.js?v=385']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=385','anton-plan-rules.js?v=385','program-management-patch.js?v=385','start-program-picker.js?v=385','program-delete.js?v=385','trainer-self-plan.js?v=385','client-free-workout.js?v=385']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=385','workout-duration.js?v=385','cardio-timer.js?v=385','advanced-training.js?v=385','workout-template-ux.js?v=385','cardio-exercise-library.js?v=385','client-workout-scroll.js?v=385']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=385','sheet-swipe.js?v=385','stats-dashboard.js?v=385','stats-authority.js?v=385']),'stats modules');
 const trainer=Promise.allSettled([
  safe(loadExternalScript('clients-action-layout.js?v=385'),'trainer layout'),
  safe(loadExternalScript('offline-progress.js?v=385'),'offline progress')
 ]);
