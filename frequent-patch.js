...
function startDeferredModules(){
 ...
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=386','anton-plan-rules.js?v=386','trainer-self-plan.js?v=386','client-free-workout.js?v=386']),'program modules');
