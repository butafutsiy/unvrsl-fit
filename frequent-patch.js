...
(()=>{
 const sources=[
  'premium-ui.js?v=414','stable-ui.js?v=414','mockup-ui.js?v=414','density-ui.js?v=414',
  'mobile-final-fix.js?v=414','home-stats.js?v=414',
  'client-nav-hotfix.js?v=414','trainer-shell.js?v=414'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=414','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=414','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=414','client-link.js?v=414','auth-password.js','checkin.js?v=414','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=414','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=414','offline-schedule.js?v=414','trainer-clients-canonical.js?v=414'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=414','female-program-templates.js?v=414']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=414','anton-plan-rules.js?v=414','trainer-self-plan.js?v=414','client-free-workout.js?v=414']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=414','workout-duration.js?v=414','cardio-timer.js?v=414','advanced-training.js?v=414','workout-template-ux.js?v=414','cardio-exercise-library.js?v=414','client-workout-scroll.js?v=414']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=414','sheet-swipe.js?v=414','stats-dashboard.js?v=414','stats-authority.js?v=414']),'stats modules');
