...
(()=>{
 const sources=[
  'premium-ui.js?v=411','stable-ui.js?v=411','mockup-ui.js?v=411','density-ui.js?v=411',
  'mobile-final-fix.js?v=411','home-stats.js?v=411',
  'client-nav-hotfix.js?v=411','trainer-shell.js?v=411'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=411','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=411','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=411','client-link.js?v=411','auth-password.js','checkin.js?v=411','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=411','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=411','offline-schedule.js?v=411','trainer-clients-canonical.js?v=411'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=411','female-program-templates.js?v=411']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=411','anton-plan-rules.js?v=411','trainer-self-plan.js?v=411','client-free-workout.js?v=411']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=411','workout-duration.js?v=411','cardio-timer.js?v=411','advanced-training.js?v=411','workout-template-ux.js?v=411','cardio-exercise-library.js?v=411','client-workout-scroll.js?v=411']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=411','sheet-swipe.js?v=411','stats-dashboard.js?v=411','stats-authority.js?v=411']),'stats modules');
