...
(()=>{
 const sources=[
  'premium-ui.js?v=427','stable-ui.js?v=427','mockup-ui.js?v=427','density-ui.js?v=427',
  'mobile-final-fix.js?v=427','home-stats.js?v=427',
  'client-nav-hotfix.js?v=427','trainer-shell.js?v=427'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=427','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=427','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=427','client-link.js?v=427','auth-password.js','checkin.js?v=427','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=427','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=427','offline-schedule.js?v=427','trainer-clients-canonical.js?v=427'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=427','female-program-templates.js?v=427']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=427','anton-plan-rules.js?v=427','trainer-self-plan.js?v=427','client-free-workout.js?v=427']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=427','workout-duration.js?v=427','cardio-timer.js?v=427','advanced-training.js?v=427','workout-template-ux.js?v=427','cardio-exercise-library.js?v=427','client-workout-scroll.js?v=427']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=427','sheet-swipe.js?v=427','stats-dashboard.js?v=427','stats-authority.js?v=427']),'stats modules');
