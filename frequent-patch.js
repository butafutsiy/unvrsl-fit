...
(()=>{
 const sources=[
  'premium-ui.js?v=420','stable-ui.js?v=420','mockup-ui.js?v=420','density-ui.js?v=420',
  'mobile-final-fix.js?v=420','home-stats.js?v=420',
  'client-nav-hotfix.js?v=420','trainer-shell.js?v=420'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=420','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=420','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=420','client-link.js?v=420','auth-password.js','checkin.js?v=420','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=420','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=420','offline-schedule.js?v=420','trainer-clients-canonical.js?v=420'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=420','female-program-templates.js?v=420']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=420','anton-plan-rules.js?v=420','trainer-self-plan.js?v=420','client-free-workout.js?v=420']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=420','workout-duration.js?v=420','cardio-timer.js?v=420','advanced-training.js?v=420','workout-template-ux.js?v=420','cardio-exercise-library.js?v=420','client-workout-scroll.js?v=420']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=420','sheet-swipe.js?v=420','stats-dashboard.js?v=420','stats-authority.js?v=420']),'stats modules');
