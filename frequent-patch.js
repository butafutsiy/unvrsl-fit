...
setTimeout(()=>{
 ...
 loadExternalScript('workout-duration.js').catch(e=>console.warn('workout duration',e));
 loadExternalScript('advanced-training.js').then(()=>loadExternalScript('advanced-start-patch.js')).then(()=>loadExternalScript('profile-stats.js')).then(()=>loadExternalScript('premium-ui.js')).then(()=>loadExternalScript('stable-ui.js')).then(()=>loadExternalScript('mockup-ui.js')).then(()=>loadExternalScript('density-ui.js')).then(()=>loadExternalScript('mobile-final-fix.js')).then(()=>loadExternalScript('sheet-swipe.js')).then(()=>loadExternalScript('stats-dashboard-v2.js')).then(()=>loadExternalScript('home-stats-v2.js')).then(()=>loadExternalScript('stats-cleanup.js')).then(()=>loadExternalScript('client-nav-hotfix.js')).then(()=>loadExternalScript('clients-action-layout.js')).catch(e=>console.warn('advanced training',e));
 ...
 Promise.allSettled([templateChain,programChain,cloudChain]).then(()=>loadExternalScript('program-delete-fix.js')).then(()=>loadExternalScript('requested-cleanup-v2.js')).then(()=>loadExternalScript('program-delete-persistence-v3.js')).catch(e=>console.warn('program cleanup',e));
},0);
