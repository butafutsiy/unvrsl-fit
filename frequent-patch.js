...
(()=>{
 const sources=[
  'premium-ui.js?v=394','stable-ui.js?v=394','mockup-ui.js?v=394','density-ui.js?v=394',
  'mobile-final-fix.js?v=394','home-stats.js?v=394',
  'client-nav-hotfix.js?v=394','trainer-shell.js?v=394'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=394','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=394','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=394','client-link.js?v=394','auth-password.js','checkin.js?v=394','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=394','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=394','offline-schedule.js?v=394','trainer-clients-canonical.js?v=394'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=394','female-program-templates.js?v=394']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=394','anton-plan-rules.js?v=394','trainer-self-plan.js?v=394','client-free-workout.js?v=394']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=394','workout-duration.js?v=394','cardio-timer.js?v=394','advanced-training.js?v=394','workout-template-ux.js?v=394','cardio-exercise-library.js?v=394','client-workout-scroll.js?v=394']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=394','sheet-swipe.js?v=394','stats-dashboard.js?v=394','stats-authority.js?v=394']),'stats modules');
