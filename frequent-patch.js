...
(()=>{
 const sources=[
  'premium-ui.js?v=419','stable-ui.js?v=419','mockup-ui.js?v=419','density-ui.js?v=419',
  'mobile-final-fix.js?v=419','home-stats.js?v=419',
  'client-nav-hotfix.js?v=419','trainer-shell.js?v=419'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=419','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=419','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=419','client-link.js?v=419','auth-password.js','checkin.js?v=419','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=419','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=419','offline-schedule.js?v=419','trainer-clients-canonical.js?v=419'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=419','female-program-templates.js?v=419']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=419','anton-plan-rules.js?v=419','trainer-self-plan.js?v=419','client-free-workout.js?v=419']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=419','workout-duration.js?v=419','cardio-timer.js?v=419','advanced-training.js?v=419','workout-template-ux.js?v=419','cardio-exercise-library.js?v=419','client-workout-scroll.js?v=419']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=419','sheet-swipe.js?v=419','stats-dashboard.js?v=419','stats-authority.js?v=419']),'stats modules');
