...
setTimeout(()=>{
 ...
 Promise.allSettled([templateChain,programChain,cloudChain]).then(()=>loadExternalScript('program-delete-fix.js')).then(()=>loadExternalScript('requested-cleanup-v2.js')).then(()=>loadExternalScript('program-delete-persistence-v3.js')).then(()=>loadExternalScript('adaptive-effort-v2.js')).catch(e=>console.warn('program cleanup/adaptive effort',e));
},0);
