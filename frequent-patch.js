...
(()=>{
 const sources=[
  'premium-ui.js?v=396','stable-ui.js?v=396','mockup-ui.js?v=396','density-ui.js?v=396',
  'mobile-final-fix.js?v=396','home-stats.js?v=396',
  'client-nav-hotfix.js?v=396','trainer-shell.js?v=396'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=396','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=396','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=396','client-link.js?v=396','auth-password.js','checkin.js?v=396','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=396','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=396','offline-schedule.js?v=396','trainer-clients-canonical.js?v=396'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=396','female-program-templates.js?v=396']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=396','anton-plan-rules.js?v=396','trainer-self-plan.js?v=396','client-free-workout.js?v=396']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=396','workout-duration.js?v=396','cardio-timer.js?v=396','advanced-training.js?v=396','workout-template-ux.js?v=396','cardio-exercise-library.js?v=396','client-workout-scroll.js?v=396']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=396','sheet-swipe.js?v=396','stats-dashboard.js?v=396','stats-authority.js?v=396']),'stats modules');
