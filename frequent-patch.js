...
(()=>{
 const sources=[
  'premium-ui.js?v=395','stable-ui.js?v=395','mockup-ui.js?v=395','density-ui.js?v=395',
  'mobile-final-fix.js?v=395','home-stats.js?v=395',
  'client-nav-hotfix.js?v=395','trainer-shell.js?v=395'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=395','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=395','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=395','client-link.js?v=395','auth-password.js','checkin.js?v=395','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=395','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=395','offline-schedule.js?v=395','trainer-clients-canonical.js?v=395'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=395','female-program-templates.js?v=395']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=395','anton-plan-rules.js?v=395','trainer-self-plan.js?v=395','client-free-workout.js?v=395']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=395','workout-duration.js?v=395','cardio-timer.js?v=395','advanced-training.js?v=395','workout-template-ux.js?v=395','cardio-exercise-library.js?v=395','client-workout-scroll.js?v=395']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=395','sheet-swipe.js?v=395','stats-dashboard.js?v=395','stats-authority.js?v=395']),'stats modules');
