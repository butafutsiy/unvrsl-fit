...
(()=>{
 const sources=[
  'premium-ui.js?v=380','stable-ui.js?v=380','mockup-ui.js?v=380','density-ui.js?v=380',
  'mobile-final-fix.js?v=380','home-stats.js?v=380',
  'client-nav-hotfix.js?v=380','trainer-shell.js?v=380'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=380','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=380','client-link.js','auth-password.js','checkin.js','checkin-singleton-fix.js','offline-clients.js','offline-create-measures.js','online-progress.js','client-ui-fix.js?v=380','trainer-plan-controls.js','trainer-tap-fix.js','trainer-direct-ui.js'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=380','female-program-templates.js?v=380']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=380','anton-plan-rules.js?v=380','program-management-patch.js?v=380','start-program-picker.js?v=380','program-delete.js?v=380','trainer-self-plan.js?v=380','client-free-workout.js?v=380']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=380','workout-duration.js?v=380','cardio-timer.js?v=380','advanced-training.js?v=380','workout-template-ux.js?v=380','cardio-exercise-library.js?v=380','client-workout-scroll.js?v=380']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=380','sheet-swipe.js?v=380','stats-dashboard.js?v=380','stats-authority.js?v=380']),'stats modules');
 const trainer=Promise.allSettled([
  safe(loadExternalScript('clients-action-layout.js?v=380'),'trainer layout'),
  safe(loadExternalScript('offline-progress.js?v=380'),'offline progress')
 ]);
