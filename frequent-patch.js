...
(()=>{
 const sources=[
  'premium-ui.js?v=409','stable-ui.js?v=409','mockup-ui.js?v=409','density-ui.js?v=409',
  'mobile-final-fix.js?v=409','home-stats.js?v=409',
  'client-nav-hotfix.js?v=409','trainer-shell.js?v=409'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=409','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=409','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=409','client-link.js?v=409','auth-password.js','checkin.js?v=409','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=409','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=409','offline-schedule.js?v=409','trainer-clients-canonical.js?v=409'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=409','female-program-templates.js?v=409']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=409','anton-plan-rules.js?v=409','trainer-self-plan.js?v=409','client-free-workout.js?v=409']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=409','workout-duration.js?v=409','cardio-timer.js?v=409','advanced-training.js?v=409','workout-template-ux.js?v=409','cardio-exercise-library.js?v=409','client-workout-scroll.js?v=409']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=409','sheet-swipe.js?v=409','stats-dashboard.js?v=409','stats-authority.js?v=409']),'stats modules');
