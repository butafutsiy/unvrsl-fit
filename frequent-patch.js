...
(()=>{
 const sources=[
  'premium-ui.js?v=417','stable-ui.js?v=417','mockup-ui.js?v=417','density-ui.js?v=417',
  'mobile-final-fix.js?v=417','home-stats.js?v=417',
  'client-nav-hotfix.js?v=417','trainer-shell.js?v=417'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=417','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=417','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=417','client-link.js?v=417','auth-password.js','checkin.js?v=417','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=417','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=417','offline-schedule.js?v=417','trainer-clients-canonical.js?v=417'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=417','female-program-templates.js?v=417']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=417','anton-plan-rules.js?v=417','trainer-self-plan.js?v=417','client-free-workout.js?v=417']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=417','workout-duration.js?v=417','cardio-timer.js?v=417','advanced-training.js?v=417','workout-template-ux.js?v=417','cardio-exercise-library.js?v=417','client-workout-scroll.js?v=417']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=417','sheet-swipe.js?v=417','stats-dashboard.js?v=417','stats-authority.js?v=417']),'stats modules');
