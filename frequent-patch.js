...
(()=>{
 const sources=[
  'premium-ui.js?v=418','stable-ui.js?v=418','mockup-ui.js?v=418','density-ui.js?v=418',
  'mobile-final-fix.js?v=418','home-stats.js?v=418',
  'client-nav-hotfix.js?v=418','trainer-shell.js?v=418'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=418','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=418','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=418','client-link.js?v=418','auth-password.js','checkin.js?v=418','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=418','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=418','offline-schedule.js?v=418','trainer-clients-canonical.js?v=418'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=418','female-program-templates.js?v=418']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=418','anton-plan-rules.js?v=418','trainer-self-plan.js?v=418','client-free-workout.js?v=418']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=418','workout-duration.js?v=418','cardio-timer.js?v=418','advanced-training.js?v=418','workout-template-ux.js?v=418','cardio-exercise-library.js?v=418','client-workout-scroll.js?v=418']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=418','sheet-swipe.js?v=418','stats-dashboard.js?v=418','stats-authority.js?v=418']),'stats modules');
