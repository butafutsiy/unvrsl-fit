...
(()=>{
 const sources=[
  'premium-ui.js?v=393','stable-ui.js?v=393','mockup-ui.js?v=393','density-ui.js?v=393',
  'mobile-final-fix.js?v=393','home-stats.js?v=393',
  'client-nav-hotfix.js?v=393','trainer-shell.js?v=393'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=393','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=393','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=393','client-link.js?v=393','auth-password.js','checkin.js?v=393','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=393','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=393','offline-schedule.js?v=393','trainer-clients-canonical.js?v=393'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=393','female-program-templates.js?v=393']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=393','anton-plan-rules.js?v=393','trainer-self-plan.js?v=393','client-free-workout.js?v=393']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=393','workout-duration.js?v=393','cardio-timer.js?v=393','advanced-training.js?v=393','workout-template-ux.js?v=393','cardio-exercise-library.js?v=393','client-workout-scroll.js?v=393']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=393','sheet-swipe.js?v=393','stats-dashboard.js?v=393','stats-authority.js?v=393']),'stats modules');
