...
(()=>{
 const sources=[
  'premium-ui.js?v=433','stable-ui.js?v=433','mockup-ui.js?v=433','density-ui.js?v=433',
  'mobile-final-fix.js?v=433','home-stats.js?v=433',
  'client-nav-hotfix.js?v=433','trainer-shell.js?v=433'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=433','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=433','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=433','client-link.js?v=433','auth-password.js','checkin.js?v=433','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=433','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=433','offline-schedule.js?v=433','trainer-clients-canonical.js?v=433'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=433','female-program-templates.js?v=433']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=433','anton-plan-rules.js?v=433','trainer-self-plan.js?v=433','client-free-workout.js?v=433']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=433','workout-duration.js?v=433','cardio-timer.js?v=433','advanced-training.js?v=433','workout-template-ux.js?v=433','cardio-exercise-library.js?v=433','client-workout-scroll.js?v=433']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=433','sheet-swipe.js?v=433','stats-dashboard.js?v=433','stats-authority.js?v=433']),'stats modules');
