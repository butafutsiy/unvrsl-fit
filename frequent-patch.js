...
(()=>{
 const sources=[
  'premium-ui.js?v=416','stable-ui.js?v=416','mockup-ui.js?v=416','density-ui.js?v=416',
  'mobile-final-fix.js?v=416','home-stats.js?v=416',
  'client-nav-hotfix.js?v=416','trainer-shell.js?v=416'
 ];
 const seen=new Set();
...
async function loadCloudModules(){
 ...
 try{
  ...
  for(const src of ['cloud-config.js','cloud.js?v=416','auth-ux.js','auth-handoff.js','trainer-style.js','trainer.js?v=416','trainer-nav-patch.js','progression.js','cloud-patch.js','cloud-programs.js','app-mode.js?v=416','client-link.js?v=416','auth-password.js','checkin.js?v=416','checkin-singleton-fix.js','online-progress.js','client-ui-fix.js?v=416','trainer-plan-controls.js','trainer-direct-ui.js','offline-progress.js?v=416','offline-schedule.js?v=416','trainer-clients-canonical.js?v=416'])await loadExternalScript(src);
...
function startDeferredModules(){
 ...
 const templates=safe(loadSequence(['popular-programs.js?v=416','female-program-templates.js?v=416']),'program templates');
 const programs=safe(loadSequence(['anton-gorkusha-plan.js?v=416','anton-plan-rules.js?v=416','trainer-self-plan.js?v=416','client-free-workout.js?v=416']),'program modules');
 const workout=safe(loadSequence(['wake-lock.js?v=416','workout-duration.js?v=416','cardio-timer.js?v=416','advanced-training.js?v=416','workout-template-ux.js?v=416','cardio-exercise-library.js?v=416','client-workout-scroll.js?v=416']),'workout modules');
 const stats=safe(loadSequence(['profile-strength-core.js?v=416','sheet-swipe.js?v=416','stats-dashboard.js?v=416','stats-authority.js?v=416']),'stats modules');
