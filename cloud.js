...
(()=>{if(document.querySelector('script[data-unvrsl-persistence]'))return;const s=document.createElement('script');s.src='./persistence-safety.js?v=395';s.dataset.unvrslPersistence='1';document.head.appendChild(s)})();
