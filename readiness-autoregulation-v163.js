...
(()=>{
  ...
  function mark(name){ready[name]=true;if(Object.values(ready).every(Boolean)){window.__unvrslReadinessStackReadyV257=true;window.dispatchEvent(new CustomEvent('unvrsl:readiness-ready',{detail:{release:257}}))}}
  let attempts=0;
  function load(){
    ...
    s.src=`training-engine-v200.js?v=257-${attempts}`;
  ...
  function loadQuestionnaire(){
    ...
    q.src='readiness-questionnaire-v227.js?v=257';q.async=false;q.dataset.unvrslReadinessV227='1';q.onload=()=>{if(window.__unvrslReadinessQuestionnaireV227)mark('questionnaire')};
  ...
  function loadExactPlanFix(){
    ...
    f.src='exact-plan-fix-v228.js?v=257';f.async=false;f.dataset.unvrslExactPlanV230='1';f.onload=()=>{if(window.__unvrslExactPlanFixV257)mark('exact')};
