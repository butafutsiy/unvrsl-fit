...
(()=>{
  ...
  function load(){
    ...
    s.src=`training-engine-v200.js?v=229-${attempts}`;
  ...
  function loadQuestionnaire(){
    ...
    q.src='readiness-questionnaire-v227.js?v=229';q.async=false;q.dataset.unvrslReadinessV227='1';
    document.body.appendChild(q)
  }
  function loadExactPlanFix(){
    if(window.__unvrslExactPlanFixV229||document.querySelector('script[data-unvrsl-exact-plan-v229]'))return;
    const f=document.createElement('script');
    f.src='exact-plan-fix-v228.js?v=229';f.async=false;f.dataset.unvrslExactPlanV229='1';
